    ...
    <>
      <section className='w-full pb-20' ref={sectionRef}>
        ...
        <div className='relative w-full max-w-area-cards h-area-cards mx-auto'>
          ...
          <Image src={Card02} ref={card02Ref} className='absolute left-0 bottom-32 opacity-0' alt='Card 01' />
          <Image src={Card03} ref={card03Ref} className='absolute bottom-0 left-80 opacity-0' alt='Card 01' />
          <Image src={Card04} ref={card04Ref} className='absolute top-0 right-32 opacity-0' alt='Card 01' />
          <Image src={Card05} ref={card05Ref} className='absolute right-0 bottom-28 opacity-0' alt='Card 01' />
          <Image src={Card06} ref={card06Ref} className='absolute bottom-0 right-80 opacity-0' alt='Card 01' />
        </div>
      </section>
    </>
  )
