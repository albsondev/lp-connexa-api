...
export function Topo() {
  ...
  useEffect(() => {
    ...
    // Função para verificar a origem do clique
    const checkParent = (target: EventTarget | null, elm: HTMLElement | null): boolean => {
      while (target && target instanceof Node) {
    ...
    <div className="pt-24">
      <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-3/5 py-6 text-center">
          <Image className="w-full md:w-4/5 z-50" src={HeroImg} alt="Hero image" width={800} height={600} />
        </div>
      </div>
    </div>
